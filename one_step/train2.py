...
from model3 import CNNDQN
from collections import deque
from copy import copy
from gym.wrappers import Monitor


def process_train(id, global_model, global_optimizer, args,eps_start=1.0, eps_final=0.01, epsilon_decay = 100000,Iutarget=5):
    ...
    for episode in range(args.num_episodes):
        ...
        while True:
            ...
            target_qvals = reward + (1 - done) * args.gamma * next_qvals_max
